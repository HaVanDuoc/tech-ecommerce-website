...
import { FormatFullName, formatCost, formatPrice, formatVND } from "~/helper/format"
...
const Profile = () => {
    ...
    return (
        <Fragment>
            ...
            <Background />
            <InfoBar
                countPayment={currentUser.isLogged && currentUser.user.data.transactionVolume}
                                                ...
                                                {fetch.data[index] &&
                                                    fetch.data[index].orderItem.map((item, index) => (
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <img src={JSON.parse(item.image)[0].base64} alt="" />
                                                            </Box>
