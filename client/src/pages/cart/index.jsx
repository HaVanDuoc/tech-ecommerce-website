                                                    ...
                                                    (item, index) => {
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                {/* Số lượng */}
                                                                <Box
                                                                    className={`col-3 box-quantity-${index}`}
                                                                >
                                                                    <Box
                                                                        sx={
                                                                            styles
                                                ...
                                                >
                                                    ...
                                                    <Box
                                                        sx={{
                                                            ...
                                                            cursor: "pointer",
                                                            boxShadow:
                                                                "0 1px 5px 1px rgba(0, 0, 0, 0.25)",
                                                            transition:
                                                                "all .2s ease-in-out",

                                                            ":hover": {
                                                                boxShadow:
                                                                    "0 1px 5px 5px rgba(0, 0, 0, 0.25)",
                                                            },
                                                        }}
                                                        onClick={handleOrder}
                                                    >
                                ...
                                >
                                    <Box sx={{ pointerEvents: "none" }}>
                                        <img
                                            src={
                                                PF +
                                                "/assets/cart/empty-cart-removebg-preview.png"
                                            }
                                            alt=""
                                            width="270px"
                                        />
