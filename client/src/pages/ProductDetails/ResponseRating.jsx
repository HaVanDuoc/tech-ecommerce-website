  ...
  return (
    <SectionRating>
      <Container maxWidth="lg" disableGutters>
        <WrapRating>
          <RatingHeader>Đánh giá sản phẩm</RatingHeader>
          <RatingContent>
            <ListRating>
                        ...
                        <Box className="reviews">
                          ...
                          <Box>
                            ...
                            <Typography variant="span" className="result">
                              ...
                              elit. Nemo eum unde at suscipit cupiditate?
                              Consectetur at quis est repudiandae, beatae quo
                              dicta facilis commodi expedita eius, libero
                              eveniet nobis ipsum.
                            </Typography>
                          </Box>
                        </Box>

                        <Box className="likeRating">
                          <ThumbUpAltOutlinedIcon className="icon" />
                          <Typography className="timesLike">34</Typography>
                        </Box>
                      </Grid>
                    </Grid>
                  </Box>
...
const RatingHeader = styled(Typography)(() => ({
